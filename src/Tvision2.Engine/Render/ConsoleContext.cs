...
public readonly struct ConsoleContext
{
    ...
    public void DrawCharsAt(char value, int count, TvPoint location, TvColorsPair colors)
    {
        ...
        _console.DrawCharactersAt(value,count, consoleLocation, attr, _viewport.Viewzone);
    }
