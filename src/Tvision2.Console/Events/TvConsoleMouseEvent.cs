...
public sealed class TvConsoleMouseEvent
{
    ...
    public TvConsoleMouseEvent(int x, int y, TvMouseButtonStates buttonStates)
    {
        ...
        IsDoubleClickEvent = (ButtonStates & TvMouseButtonStates.LeftButtonDoubleClicked) ==
                             TvMouseButtonStates.LeftButtonDoubleClicked ||
                             (ButtonStates & TvMouseButtonStates.RightButtonDoubleClicked) ==
                             TvMouseButtonStates.RightButtonClicked ||
                             (ButtonStates & TvMouseButtonStates.SecondLeftButtonDoubleClicked) ==
                             TvMouseButtonStates.SecondLeftButtonDoubleClicked ||
                             (ButtonStates & TvMouseButtonStates.ThirdLeftButtonDoubleClicked) ==
                             TvMouseButtonStates.ThirdLeftButtonDoubleClicked;

        IsClickEvent =
            (ButtonStates & TvMouseButtonStates.LeftButtonClicked) == TvMouseButtonStates.LeftButtonClicked ||
            (ButtonStates & TvMouseButtonStates.RightButtonClicked) == TvMouseButtonStates.RightButtonClicked ||
            (ButtonStates & TvMouseButtonStates.SecondLeftButtonClicked) ==
            TvMouseButtonStates.SecondLeftButtonClicked ||
            (ButtonStates & TvMouseButtonStates.ThirdLeftButtonClicked) == TvMouseButtonStates.ThirdLeftButtonClicked;

        IsPressedEvent =
            (ButtonStates & TvMouseButtonStates.LeftButtonPressed) == TvMouseButtonStates.LeftButtonPressed ||
            (ButtonStates & TvMouseButtonStates.RightButtonPressed) == TvMouseButtonStates.RightButtonPressed ||
            (ButtonStates & TvMouseButtonStates.SecondLeftButtonPressed) ==
            TvMouseButtonStates.SecondLeftButtonPressed ||
            (ButtonStates & TvMouseButtonStates.ThirdLeftButtonPressed) == TvMouseButtonStates.ThirdLeftButtonPressed;

        IsReleasedEvent = (ButtonStates & TvMouseButtonStates.LeftButtonReleased) ==
                          TvMouseButtonStates.LeftButtonReleased ||
                          (ButtonStates & TvMouseButtonStates.RightButtonReleased) ==
                          TvMouseButtonStates.RightButtonReleased ||
                          (ButtonStates & TvMouseButtonStates.SecondLeftButtonReleased) ==
                          TvMouseButtonStates.SecondLeftButtonReleased ||
                          (ButtonStates & TvMouseButtonStates.ThirdLeftButtonReleased) ==
                          TvMouseButtonStates.ThirdLeftButtonReleased;
    }
