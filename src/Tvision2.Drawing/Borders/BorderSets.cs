...
public class BorderSets
{
    ...
    private static void FillCharacters()
    {
        ...
        _characters.Add(BorderValue.HorizontalVertical(BorderType.Double, BorderType.None), ['\u2550', '\u2550', '\u2550', ' ', '\u2550', '\u2550', '\u2550', '\u2550', '\u2550', ' ', ' ']);
        _characters.Add(BorderValue.HorizontalVertical(BorderType.Single, BorderType.None), ['\u2500', '\u2500', '\u2500', ' ', '\u2500', '\u2500', '\u2500', '\u2500', '\u2500', ' ', ' ']);
        _characters.Add(BorderValue.HorizontalVertical(BorderType.Fill, BorderType.None), ['\u2591', '\u2591', '\u2591', ' ', '\u2591', '\u2591', '\u2591', '\u2591', '\u2591', ' ', ' ']);
        _characters.Add(BorderValue.HorizontalVertical(BorderType.None, BorderType.Double), [' ', ' ', ' ', '\u2551', ' ', ' ', ' ', ' ', '\u2551', '\u2550', '\u2550']);
        _characters.Add(BorderValue.HorizontalVertical(BorderType.None, BorderType.Single), [' ', ' ', ' ', '\u2502', ' ', ' ', ' ', ' ', '\u2502', '\u2500', '\u2500']);
        _characters.Add(BorderValue.HorizontalVertical(BorderType.None, BorderType.Fill), [' ', ' ', ' ', '\u2591', ' ', ' ', ' ', ' ', '\u2591', '\u2591', '\u2591']);
    }
